...
export default class Newevent extends Component {
    ...
    render() {
        ...
        <Layout className="layout" >
            ...
            <Row gutter={48}>
              <Col span={8} offset={2}>
                <img style={{width:"500px",height:"250px"}} src="https://cdn.pixabay.com/photo/2015/04/20/13/10/rock-731140__340.jpg"/>
              </Col>
              <Col span={8} offset={2}>
                <img style={{width:"500px",height:"250px"}} src="https://cdn.pixabay.com/photo/2015/03/26/10/34/tricycle-691587__340.jpg"/>
              </Col>
            </Row>
            <br/>
